                    ...
                    <div class="col-md-3 col-sm-6">
                        ...
                        <div class="thumbnail">
                            ...
                            <div class="caption">
                                ...
                                <p><a href="{{ route('object') }}" class="btn btn-primary" role="button">Details</a><a href="./?view=room#reservation" class="btn btn-success pull-right" role="button">Reservation</a></p>
                            </div>
                        </div>
                    </div>
